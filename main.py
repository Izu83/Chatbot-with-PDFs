...
#     else:
#         print(f"New PDFs found: {new_files}")
...
# And over here, below this comment is going to be the ui version together with Streamlit.
# Its absouletly the same principe of the one above this comment but it will include
# a streamlit Ui
